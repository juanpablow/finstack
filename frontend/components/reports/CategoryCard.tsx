...
export function CategoryCard({ categoryName, expenses, onAddExpense, onEditExpense, onDeleteExpense }: CategoryCardProps) {
  ...
  const startEdit = (expense: Expense) => {
    ...
    setEditValue("R$ " + expense.value.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 }))
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-8">
      ...
      <div className="mb-6">
        {expenses.length === 0 ? (
          <p className="text-gray-400 text-center py-8">Nenhum custo adicionado</p>
        ) : (
          <div>
            {expenses.map((expense) => (
              <ExpenseItem
                ...
                onEditValueChange={(value) => setEditValue(formatCurrency(value))}
