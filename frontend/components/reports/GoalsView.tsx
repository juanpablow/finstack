...
export function GoalsView({
  ...
  const totalPercentage = Object.values(localPercentages).reduce(
    (sum, val) => sum + val,
    0
  );
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="flex items-center justify-center bg-white rounded-2xl shadow-md p-8h-full">
              ...
              <div key={cat.name}>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleSliderChange(cat.name, parseInt(e.target.value))
                    }
